        ...
        public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
                httpSecurity
                                ...
                                .authorizeHttpRequests(matcherRegistry -> matcherRegistry
                                                .requestMatchers(HttpMethod.POST, "/api/v1/auth/code-admin")
                                                .hasAnyAuthority("ADMIN")
                                                .requestMatchers(HttpMethod.POST, "/api/v1/auth/code-manager")
                                                .hasAnyAuthority("ADMIN")
                                                ...
                                                .requestMatchers(HttpMethod.POST, "/cars/activate/{id}")
                                                .hasAnyAuthority("MANAGER", "ADMIN")
                                                .requestMatchers(HttpMethod.POST, "/cars/ban/{id}")
                                                .hasAnyAuthority("MANAGER", "ADMIN")
                                                ...
                                                .hasAnyAuthority("USER", "ADMIN", "MANAGER")
                                                .requestMatchers(HttpMethod.PATCH, "/cars/**")
                                                .hasAnyAuthority("USER", "ADMIN")

                                                .requestMatchers(HttpMethod.GET, "/payments/buy-premium")
                                                .hasAnyAuthority("USER")
                                                .requestMatchers(HttpMethod.POST, "/payments/add-payment-source")
                                                .hasAnyAuthority("USER")

                                                .requestMatchers(HttpMethod.DELETE, "/sellers/**")
                                                .hasAnyAuthority("USER", "ADMIN", "MANAGER")
                                                .requestMatchers(HttpMethod.PATCH, "sellers/**")
                                                .hasAnyAuthority("USER", "ADMIN")
                                                .requestMatchers(HttpMethod.GET, "sellers").hasAnyAuthority("ADMIN")

                                                .requestMatchers(HttpMethod.GET, "/managers/**")
                                                .hasAnyAuthority("ADMIN")
                                                .requestMatchers(HttpMethod.POST, "/managers").hasAnyAuthority("ADMIN")
                                                .requestMatchers(HttpMethod.DELETE, "/managers/**")
                                                .hasAnyAuthority("ADMIN", "MANAGER")
                                                .requestMatchers(HttpMethod.PATCH, "/managers/**")
                                                .hasAnyAuthority("ADMIN", "MANAGER")
                                                ...
                                                .hasAnyAuthority("ADMIN")
                                                .requestMatchers(HttpMethod.DELETE, "/administrators/**")
                                                .hasAnyAuthority("ADMIN")
                                                .requestMatchers(HttpMethod.PATCH, "/administrators/**")
                                                .hasAnyAuthority("ADMIN")
                                                ...
                                                .hasAnyAuthority("USER", "ADMIN")
                                                .requestMatchers(HttpMethod.PATCH, "/customers/**")
